                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-header">
                                <a class="btn btn-success" href="create.php">[+] Create Data Jenis Produk</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php $nomor = 1; foreach($sembako as $data) { ?>
                                        <tr>
                                            <td><?=$nomor?></td>
                                            ...
                                            <a class="btn btn-danger" href="delete.php?iddel=<?=$data['id']?>"
                                                onclick="if(!confirm('Anda Yakin Hapus Data Motor <?=$data['jenis_produk']?>?')) {return false}">Delete</a>
                                            </td>
                                        </tr>
                                    <?php $nomor++; }?>
                                    </tbody>
