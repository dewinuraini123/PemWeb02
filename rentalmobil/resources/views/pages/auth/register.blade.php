                                    ...
                                    <div class="card-body">
                                        <form action="/register/proses" method="POST">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputName" type="text" placeholder="Fullname" name="name"/>
                                                <label for="inputName">Nama Lengkap</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputContact" type="text" placeholder="contact" name="contact"/>
                                                <label for="inputContact">Kontak</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="email" placeholder="example : name@example.com" name="email"/>
